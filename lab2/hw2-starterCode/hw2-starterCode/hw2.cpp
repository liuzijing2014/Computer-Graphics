...
Vertex skyVertices[8] = {
	{ {-64.0, 64.0, 64.0}, {1.0, 1.0, 1.0, -1.0}, {0.0, 0.0} },
	{ {-64.0, -64.0, 64.0}, {1.0, 1.0, 1.0, -1.0}, {0.0, 0.0} },
	{ {64.0, -64.0, 64.0}, {1.0, 1.0, 1.0, -1.0}, {0.0, 0.0} },
	{ {64.0, 64.0, 64.0}, {1.0, 1.0, 1.0, -1.0}, {0.0, 0.0} },
...
GLuint loadSkybox(const GLchar* faces);
...
void subDivideSegment(float u0, float u1, glm::mat4x4& matrix)
{
	...
	{
		Vertex v;
		v.XYZ[0] = v0.x * splineScale;
		v.XYZ[1] = v0.y * splineScale;
		v.XYZ[2] = v0.z * splineScale;
		v.RGBA[0] = v.RGBA[1] = v.RGBA[2] = v.RGBA[3] = 1.0;
		v.TEX[0] = v.TEX[1] = 0.0;
		verticesVector.push_back(v);
		v.XYZ[0] = v1.x * splineScale;
		v.XYZ[1] = v1.y * splineScale;
		v.XYZ[2] = v1.z * splineScale;
		verticesVector.push_back(v);
	}
}
